...
public class JwtTokenHelper {
	...
	//for retrieving any kind of token
	...
	//2.Sign the JWT using the HS512 algorithm and secret token
	//3. According to JWS compact Serilizations (https://tools.ietf.org/html/draft-ieft-jose)
